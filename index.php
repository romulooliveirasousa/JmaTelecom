...
<div id="myCarousel" class="carousel slide banners" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <a href="#" class="item active fill banner-institucional"
           style="background-image: url(midia/bg-institucional.jpg)">
            <div class="container">
                <div class="col-md-4 col-md-offset-1 meio">
                    <!--                        <img src="imagens/logo.jpeg" class="img-responsive">-->
                </div>
            </div>
        </a>

        <a href="#" class="item fill" style="background-image: url(midia/bg-para-sua-empresa.jpg)">
            <div class="container">
                <div class="col-md-4 col-md-offset-1 meio">
                    <img src="midia/para-sua-empresa-branco.png" class="img-responsive">
                </div>
                <div class="col-md-5 col-md-offset-1 ">
                    <div class="text-banner meio text-right">
                        <div style="height: auto">
                            <strong>Soluções de alta performance</strong><br>
                            para qualquer situação.<br/>
                            <span class="saiba-mais-banner bg-azul">saiba mais</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="#" class="item fill" style="background-image: url(midia/bg-para-voce-urbano.jpg)">
            <div class="container">
                ...
                <div class="col-md-5 col-md-offset-1 ">
                    <div class="text-banner meio text-right">
                        <div style="height: auto">
                            <strong>Abrace todas as possibilidades</strong><br>
                            que a tecnologia pode oferecer.<br/>
                            <span class="saiba-mais-banner bg-azul">saiba mais</span>
                        </div>
                    </div>
                </div>
        ...
        <a href="#" class="item fill" style="background-image: url(imagens/4.jpeg)">
            <div class="container">
                <div class="col-md-4 col-md-offset-1 meio">
                    <!--                        <img src="midia/para-voce-urbano-branco.png" class="img-responsive">-->
                </div>
        ...
        <a href="#" class="item fill" style="background-image: url(midia/bg-para-voce-rural.jpg)">
            <div class="container">
                ...
                <div class="col-md-5 col-md-offset-1 ">
                    <div class="text-banner meio text-right">
                        <div style="height: auto">
                            <strong>Não importa a distância, </strong><br>
...
<div class="planosHome">
    ...
    <div class="container">
        ...
        <div class="col-md-4 text-center azul">
            <div class="row">
                <img src="midia/para-voce-urbano.png" class="img-responsive"/>
                Abrace todas as possibilidades que a <br/>tecnologia pode oferecer.
                <a href="#" class="saiba-mais-full bg-azul">saiba mais sobre este serviço</a>
            </div>
        </div>
        <div class="col-md-4 text-center azul">
            <div class="row">
                <img src="midia/para-voce-rural.png" class="img-responsive"/>
                Não importa a distância, a gente <br/>
                vai até você.
                <a href="#" class="saiba-mais-full bg-azul">saiba mais sobre este serviço</a>
            </div>
        </div>
        <div class="col-md-4 text-center azul">
            <div class="row">
                <img src="midia/para-sua-empresa.png" class="img-responsive"/>
                Soluções de alta performance para <br/>
                qualquer situação.
                <a href="#" class="saiba-mais-full bg-azul">saiba mais sobre este serviço</a>
            </div>
        </div>
...
<div class="area-atuacao">
    ...
    <div class="container">
        ...
        <div class="col-md-6 text-center">
            <iframe src="https://www.google.com/maps/d/u/1/embed?mid=18a11FkCzsQV_laWiESa-rHWay0g8Y16n" width="640" height="480"></iframe>
        </div>
        ...
        <div class="col-md-5 col-md-offset-1">
            ...
            <p>
                Para nós, conectar é encurtar distâncias. Por isso, dispomos de moderna infraestrutura, distribuída em
                uma ampla área que abrange 7 cidades da região do....
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                ...
                Desde 2003, aproximamos pessoas por meio de serviços de alta qualidade, oferecendo soluções inteligentes
            ...
            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <strong><b>(63) 99211 - 3967</b></strong><br
                    </div>
